...
interface UserControllerAPI {
    ...
    @Operation(summary = "User authentication by number")
    fun authenticationByNumber(request: AuthByNumberRequest): ResponseEntity<UserDto>

    @Operation(summary = "User authentication")
    fun checkIfUserExistByNumber(request: AuthByNumberRequest): ResponseEntity<Unit>
}